...
| | analyzers | api_surface | code_metrics | dependencies | import_graph | maturity | structure | cli | core | extractors | changelog_parser | docker_parser | makefile_parser | metadata | readme_parser | toon_parser | generators | article | article_sections | comparison | todocs | utils |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **analyzers** | · |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| **api_surface** |  | · |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| **code_metrics** |  |  | · |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | → |  |
